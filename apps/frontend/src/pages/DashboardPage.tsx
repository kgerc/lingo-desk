...
import { Users, GraduationCap, BookOpen, Calendar, TrendingUp, BarChart3, AlertTriangle, CreditCard, LucideIcon } from 'lucide-react';
  ...
  return (
    <div>
      ...
      {(showRevenueChart || showLessonsChart) && (
        <div className={`grid grid-cols-1 ${showRevenueChart && showLessonsChart ? 'lg:grid-cols-2' : ''} gap-6 mb-8`}>
          {/* Revenue Chart */}
          {showRevenueChart && (
